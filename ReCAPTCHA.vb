'=========================================================
' ReCAPTCHANet written in VB.NET
' WWWeb Concepts wwwebconcepts.com
' James W. Threadgill james@wwwebconcepts.com
' Copyright 2017 ' Version 1.0.0.0 wwwebconcepts.com
'=========================================================
' Based on DMXzone reCAPTCHA VB Script
' Copyright 2011-2012 (c) DMXzone.com
' Version: 1.1.
'------------------------------------------------------------------------------
' calling code
...
Public Class ReCAPTCHANet
    Public Property ErrorCodes As New List(Of WebException)
    ...
    Public Function Construct() As Boolean
        ...
        If Not String.IsNullOrEmpty(Current.Request.Form("g-recaptcha-response")) Then
            ' robots version
            m_recaptcha_response_field = Current.Request.Form("g-recaptcha-response")
    ...
    Public Overloads Function GetControl(ByVal theme As String, ByVal language As String) As String
      ...
      "<noscript>" &
        "<iframe src=""http://www.google.com/recaptcha/api/noscript?k=" & m_PublicKey & """ frameborder=""1""></iframe>" &
